  ...
  function en(t) {
    ...
    function B(n) {
      ...
      ;(M.progress = a((d / e) * 100, 0, 100)),
        ...
        M.began && D('update'),
        n >= e && ((u = 0), M.remaining && !0 !== M.remaining && M.remaining--, M.remaining ? ((o = i), D('loopComplete'), (M.loopBegan = !1), 'alternate' === M.direction && x()) : ((M.paused = !0), M.completed || ((M.completed = !0), D('loopComplete'), D('complete'), !M.passThrough && 'Promise' in window && (s(), f(M)))))
    }
    return (
      (M.reset = function () {
        var n = M.direction
